...
local Modules = GuiLibrary.CreateWindow({
    Name = "Modules",
    Icon = "vape/assets/WorldIcon.png",
    IconSize = 16
})
...
GUI.CreateButton({
	Name = "Modules", 
	Function = function(callback) Modules.SetVisible(callback) end, 
	Icon = "vape/assets/WorldIcon.png", 
	IconSize = 16
})
...
TargetInfoMainFrame.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
...
TargetInfoMainInfo.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
TargetInfoMainInfo.Size = UDim2.new(0, 230, 0, 90)
...
TargetInfoName.Text = "Display Name"
...
local windowSortOrder2 = {"Combat", "Blatant", "Render", "Utility", "World", "Modules"}
